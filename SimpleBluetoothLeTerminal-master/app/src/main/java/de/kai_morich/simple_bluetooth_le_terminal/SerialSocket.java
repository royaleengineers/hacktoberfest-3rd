...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_NRF52840_SERVICE    = UUID.fromString("19B10000-E8F2-537E-4F6C-D104768A1214");
    private static final UUID BLUETOOTH_LE_NRF52840_CHAR   = UUID.fromString("19B10001-E8F2-537E-4F6C-D104768A1214");
    ...
    private void connectCharacteristics1(BluetoothGatt gatt) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            ...
            if (gattService.getUuid().equals(BLUETOOTH_LE_NRF52840_SERVICE))
                delegate = new Nrf52840Delegate();
...
//nrf52840 characteristics
    private class Nrf52840Delegate extends DeviceDelegate {
        @Override
        boolean connectCharacteristics(BluetoothGattService gattService) {
            Log.d(TAG, "service nrf52840 uart");
            readCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_NRF52840_CHAR);
            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_NRF52840_CHAR);
            return true;
        }
    }
